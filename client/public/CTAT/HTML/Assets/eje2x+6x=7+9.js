function myDoneFunction(aSummary) {
  ...
  //console.log("🚀 ~ file: eje2x+6x=7+9.js:2 ~ aSummary:", aSummary);
  $.alert({
    title: "Felicitaciones",
    content: "Has completado con exito el ejercicio",
    buttons: {
      confirm: function () {
        document.location.href = "ejercicio5.html";
      },
    },
  });
}
...
var myVars = {
  question_file: "../FinalBRDs/ejercicio1-5.brd",
