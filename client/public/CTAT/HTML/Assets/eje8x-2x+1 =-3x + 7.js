function myDoneFunction(aSummary) {
  ...
  $.alert({
    ...
    buttons: {
      confirm: function () {
        // document.location.href = "ejercicio6.html";
      },
    },
  });
}
...
var myVars = {
  question_file: "../FinalBRDs/ejercicio6.brd",
